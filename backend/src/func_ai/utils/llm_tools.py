...
class OpenAIInterface(LLMInterface):
    ...
    def update_llm_conversation(self, **kwargs) -> "OpenAIInterface":
        ...
        try:
            ...
            print("DEBUG RESPONSE!!! in llm_tools.py")
            print(response.choices[0].message.function_call)
            print(self.conversation_store.get_conversation())
            ...
            if(response.choices[0].message.function_call):
                ...
                response.choices[0].message.function_call.arguments = response.choices[0].message.function_call.arguments.encode('utf-8').decode("utf-8")
            ...
            print("DEBUG ...update_llm_conversation")
            print(e)
...
class OpenAIFunctionWrapper(object):
    ...
    def from_response(self, llm_response: dict[str, any]) -> "OpenAIFunctionWrapper":
        print("DEBUG ...from_response!!!!!")
        print(llm_response.function_call)
        """
        Returns an instance of the class from LLM completion response
        ...
        try:
            ...
            _func_response = self.func(**json.loads(llm_response.function_call.arguments))
            print("DEBUG ...from_response pppppppp")
            print(_func_response)
        except Exception as e:
            print("DEBUG ...from_response")
